...
<div class="auth-form" style="padding: 19px;">
<div class="auth-header" style="text-align:center;">
    <div class="logo">
			<a class="navbar-brand" href="index.php"><img src="assets/img/logo.png" alt=""></a>
	</div><br>
<h4 style="font-size: 23px;color: initial;text-align:center;">Forgot Password</h4>
<p>We send you a password reset link</p>
</div>
<form action="#">
...
<button type="submit" class="auth-btn w-100 mt-0">Send Password Reset Link</button>
</form>
