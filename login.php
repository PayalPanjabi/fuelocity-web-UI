...
<h1>Login</h1>
<h6><a href="index.php">Home</a> <i class="far fa-dot-circle"></i> Login</h6>
</div>
</div>
</div>
</div>
...
<h4 style="font-size: 23px;color: initial;text-align:center;">Login</h4>
...
<button type="submit" class="auth-btn">Login</button></div>
</form>
